    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          ...
          <AnimatePresence>
            {showTooltip && (
              <m.div
                ...
                className="relative bg-white rounded-2xl shadow-xl border border-slate-100 p-4 max-w-[220px] mr-1"
              >
                <button
          ...
          >
            {/* Pulse ring */}
            <span className="absolute inset-0 rounded-full bg-emerald-500 animate-pulse-ring opacity-50" />
            {/* Button */}
            <div className="relative w-14 h-14 bg-emerald-500 hover:bg-emerald-600 rounded-full flex items-center justify-center shadow-lg shadow-emerald-500/40 hover:shadow-emerald-500/60 transition-all duration-300 hover:scale-110">
