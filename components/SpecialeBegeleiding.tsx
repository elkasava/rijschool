      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-block text-brand-600 font-semibold text-sm uppercase tracking-widest mb-3">
            {content.ui.specialeBegeleiding.sectionLabel}
          </span>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-4">
            {content.ui.specialeBegeleiding.sectionHeading}
          </h2>
          <p className="text-slate-500 text-lg max-w-2xl mx-auto">
            {content.ui.specialeBegeleiding.sectionSubheading}
          </p>
        </m.div>
        ...
        >
          <div>
            <p className="text-white font-semibold text-lg">
              {content.ui.specialeBegeleiding.ctaText}
            </p>
            <p className="text-slate-400 text-sm mt-0.5">
              {content.ui.specialeBegeleiding.ctaSub}
            </p>
          </div>
          <a
          ...
          >
            ...
            {content.ui.specialeBegeleiding.ctaBtn}
          </a>
        </m.div>
